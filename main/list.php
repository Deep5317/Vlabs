...
<body onload="resize()" onresize="resize()">
    ...
    <div class="outer-block">
        <div id="sidebar" class="side-bar" onmouseout="toggleSidebar()" onmouseover="toggleSidebar()">
            ...
            <?php } else { ?>
                <div id="menu" class="menu"><a href="./login.php" onmouseover="showBorder(1)" onmouseout="notShowBorder(1)"><span><i class="material-icons md-48">account_circle</i><span class="icon-text user"><?php echo 'Not Logged In' ?></span></a></div>
            <?php } ?>
